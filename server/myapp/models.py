...
class Thing(models.Model):
    ...
    price = models.CharField(max_length=50, blank=True, null=True) # 售价
    pricer = models.CharField(max_length=50, blank=True, null=True) # 售价范围
    mianji = models.CharField(max_length=50, blank=True, null=True)  # 面积
    mianjir = models.CharField(max_length=50, blank=True, null=True)  # 面积范围
    huxing = models.CharField(max_length=50, blank=True, null=True)  # 户型
    location = models.CharField(max_length=50, blank=True, null=True)  # 区域
    xiaoqu = models.CharField(max_length=50, blank=True, null=True)  # 小区
    louceng = models.CharField(max_length=50, blank=True, null=True)  # 楼层
    fangling = models.CharField(max_length=50, blank=True, null=True)  # 房龄
    chanquan = models.CharField(max_length=50, blank=True, null=True)  # 产权
    jungong = models.CharField(max_length=50, blank=True, null=True)  # 竣工年份
    zhuangxiu = models.CharField(max_length=50, blank=True, null=True)  # 装修类型
    xsxm = models.CharField(max_length=50, blank=True, null=True)  # 销售姓名
    xssj = models.CharField(max_length=50, blank=True, null=True)  # 销售电话
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='0')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
...
class Order(models.Model):
    ...
    receiver_time = models.CharField(max_length=50, blank=True, null=True)
