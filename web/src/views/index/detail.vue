        ...
        <div class="detail-content-top">
          ...
          <div class="top-right">
            ...
            <div style="display: flex;flex-direction: row;flex-wrap: wrap;">
              <div class="meta">价格：{{ detailData.price }}万</div>
              <div class="meta">面积：{{ detailData.mianji }}㎡</div>
              <div class="meta">户型：{{ detailData.huxing }}</div>
              <div class="meta">地区：{{ detailData.location }}</div>
              <div class="meta">小区：{{ detailData.xiaoqu }}</div>
              <div class="meta">楼层：{{ detailData.louceng }}</div>
              <div class="meta">产权：{{ detailData.chanquan }}</div>
              <div class="meta">竣工年份：{{ detailData.jungong }}</div>
              <div class="meta">装修类型：{{ detailData.zhuangxiu }}</div>
              <div class="meta">销售人员：{{ detailData.xsxm }}</div>
              <div class="meta">销售电话：{{ detailData.xssj }}</div>
            </div>
            <div class="actions">
                ...
                <div class="things">
                  <div class="thing-item" v-for="item in recommendData" @click="handleDetail(item)">
                    ...
                    <div class="info-view">
                      ...
                      <span>
                        <span class="a-price">{{ item.huxing }}</span>&nbsp;
                        <span class="a-price">{{ item.mianji }}㎡</span>&nbsp;
                        <span class="a-price">{{ item.price }}万</span>&nbsp;
                      </span>
                    </div>
                  </div>
                </div>
