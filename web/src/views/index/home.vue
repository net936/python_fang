    ...
    <div class="content">
      <div class="content-top">
        ...
        <div class="left-search-item">
          ...
          <div class="c-list">
            <div
              :class="contentData.ccc === item ? 'c-item-selected' : 'c-item'"
              v-for="item in contentData.cccData"
              :key="item"
              @click="clickCCC(item)"
            >
              {{ item }}
...
<script setup>
  ...
  const contentData = reactive({
    ...
    ccc: '全部',
    cData: [],
    ccData: ['全部', '50万以下', '50-100万', '100-150万', '150-200万', '200-300万', '300万以上'],
    cccData: ['全部', '50㎡以下', '50-80㎡', '80-120㎡', '120-150㎡', '150-200㎡', '200㎡以上'],
